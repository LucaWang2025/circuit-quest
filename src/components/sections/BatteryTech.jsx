...
function AnimCanvas({ modeRef }) {
  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      t += 0.025;
      const label = modeRef?.current || 'BMS · 充放电保护';
      ...
      ctx.fillText('三元锂 vs 磷酸铁锂、BMS 保护', W/2, H - 12);
      ...
      <div className="grid2">
        ...
        <div className="info-stack reveal">
          <div className="icard" style={{ borderLeftColor: ACC }}>
            ...
            <div style={{ fontSize: 13.5, color: '#aabfc8', lineHeight: 1.65 }}>三元锂 vs 磷酸铁锂、BMS 保护</div>
          </div>
          <div className="icard" style={{ borderLeftColor: ACC }}>
