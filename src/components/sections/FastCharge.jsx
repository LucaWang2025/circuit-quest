...
function AnimCanvas({ modeRef }) {
  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      t += 0.025;
      const label = modeRef?.current || 'USB PD 协商';
      ...
      ctx.fillText('握手时序、电压档位与安全', W/2, H - 12);
      ...
      <div className="grid2">
        ...
        <div className="info-stack reveal">
          <div className="icard" style={{ borderLeftColor: ACC }}>
            ...
            <div style={{ fontSize: 13.5, color: '#aabfc8', lineHeight: 1.65 }}>握手时序、电压档位与安全</div>
          </div>
          <div className="icard" style={{ borderLeftColor: ACC }}>
