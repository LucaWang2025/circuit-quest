...
function AnimCanvas({ modeRef }) {
  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      t += 0.025;
      const label = modeRef?.current || '光伏 DC → 逆变 AC';
      ...
      ctx.fillText('组件、逆变器、并网与储能接口', W/2, H - 12);
      ...
      <div className="grid2">
        ...
        <div className="info-stack reveal">
          <div className="icard" style={{ borderLeftColor: ACC }}>
            ...
            <div style={{ fontSize: 13.5, color: '#aabfc8', lineHeight: 1.65 }}>组件、逆变器、并网与储能接口</div>
          </div>
          <div className="icard" style={{ borderLeftColor: ACC }}>
