...
function AnimCanvas({ modeRef }) {
  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      t += 0.025;
      const label = modeRef?.current || '入户 · 电表 · 总开';
      ...
      ctx.fillText('家庭电力入口、电表、总开关与接地', W/2, H - 12);
      ...
      <div className="grid2">
        ...
        <div className="info-stack reveal">
          <div className="icard" style={{ borderLeftColor: ACC }}>
            ...
            <div style={{ fontSize: 13.5, color: '#aabfc8', lineHeight: 1.65 }}>家庭电力入口、电表、总开关与接地</div>
          </div>
          <div className="icard" style={{ borderLeftColor: ACC }}>
