...
function AnimCanvas({ modeRef }) {
  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      t += 0.025;
      const label = modeRef?.current || '三电系统 · 电池/电机/电控';
      ...
      ctx.fillText('BLDC 轮毂电机、控制器与 BMS', W/2, H - 12);
      ...
      <div className="grid2">
        ...
        <div className="info-stack reveal">
          <div className="icard" style={{ borderLeftColor: ACC }}>
            ...
            <div style={{ fontSize: 13.5, color: '#aabfc8', lineHeight: 1.65 }}>BLDC 轮毂电机、控制器与 BMS</div>
          </div>
          <div className="icard" style={{ borderLeftColor: ACC }}>
