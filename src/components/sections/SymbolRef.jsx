...
function AnimCanvas({ modeRef }) {
  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      t += 0.025;
      const label = modeRef?.current || '符号对照';
      ...
      ctx.fillText('常用符号与实物对照速查', W/2, H - 12);
...
export default function SymbolRef() {
  const modeRef = useRef('符号对照');
  return (
    <section id="symbol-ref" className="sec">
      <div className="sh">
        <span className="sh-icon">📐</span>
        <div>
          <div className="sh-tag">SYMBOL REF</div>
          <h2 className="sh-title" style={{ color: ACC, textShadow: `0 0 35px ${ACC}44` }}>电气符号</h2>
          <p className="sh-sub">常用符号与实物对照速查</p>
        </div>
      </div>
      ...
      <div className="grid2">
        ...
        <div className="info-stack reveal">
          <div className="icard" style={{ borderLeftColor: ACC }}>
            ...
            <div style={{ fontSize: 13.5, color: '#aabfc8', lineHeight: 1.65 }}>常用符号与实物对照速查</div>
          </div>
          <div className="icard" style={{ borderLeftColor: ACC }}>
