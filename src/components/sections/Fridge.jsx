...
function AnimCanvas({ modeRef }) {
  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      t += 0.025;
      const label = modeRef?.current || '压缩机运转 · 制冷剂循环';
      ...
      ctx.fillText('制冷循环、启动电容、PTC 与温控', W/2, H - 12);
      ...
      <div className="grid2">
        ...
        <div className="info-stack reveal">
          <div className="icard" style={{ borderLeftColor: ACC }}>
            ...
            <div style={{ fontSize: 13.5, color: '#aabfc8', lineHeight: 1.65 }}>制冷循环、启动电容、PTC 与温控</div>
          </div>
          <div className="icard" style={{ borderLeftColor: ACC }}>
