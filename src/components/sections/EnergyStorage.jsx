...
function AnimCanvas({ modeRef }) {
  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      t += 0.025;
      const label = modeRef?.current || '储能 · 并网调度';
      ...
      ctx.fillText('削峰填谷、户储与 V2G 概念', W/2, H - 12);
      ...
      <div className="grid2">
        ...
        <div className="info-stack reveal">
          <div className="icard" style={{ borderLeftColor: ACC }}>
            ...
            <div style={{ fontSize: 13.5, color: '#aabfc8', lineHeight: 1.65 }}>削峰填谷、户储与 V2G 概念</div>
          </div>
          <div className="icard" style={{ borderLeftColor: ACC }}>
