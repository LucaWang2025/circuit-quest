...
function AnimCanvas({ modeRef }) {
  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      t += 0.025;
      const label = modeRef?.current || '三电系统架构';
      ...
      ctx.fillText('电池包、驱动电机、电控 VCU/MCU', W/2, H - 12);
      ...
      <div className="grid2">
        ...
        <div className="info-stack reveal">
          <div className="icard" style={{ borderLeftColor: ACC }}>
            ...
            <div style={{ fontSize: 13.5, color: '#aabfc8', lineHeight: 1.65 }}>电池包、驱动电机、电控 VCU/MCU</div>
          </div>
          <div className="icard" style={{ borderLeftColor: ACC }}>
