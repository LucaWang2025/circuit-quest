...
function AnimCanvas({ modeRef }) {
  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      t += 0.025;
      const label = modeRef?.current || '元件识别';
      ...
      ctx.fillText('色环电阻、电容标识、接线端子', W/2, H - 12);
      ...
      <div className="grid2">
        ...
        <div className="info-stack reveal">
          <div className="icard" style={{ borderLeftColor: ACC }}>
            ...
            <div style={{ fontSize: 13.5, color: '#aabfc8', lineHeight: 1.65 }}>色环电阻、电容标识、接线端子</div>
          </div>
          <div className="icard" style={{ borderLeftColor: ACC }}>
