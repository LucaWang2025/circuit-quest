...
function AnimCanvas({ modeRef }) {
  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      t += 0.025;
      const label = modeRef?.current || '智能控制 · 继电器';
      ...
      ctx.fillText('零火线/单火接线、Wi-Fi 与继电器', W/2, H - 12);
      ...
      <div className="grid2">
        ...
        <div className="info-stack reveal">
          <div className="icard" style={{ borderLeftColor: ACC }}>
            ...
            <div style={{ fontSize: 13.5, color: '#aabfc8', lineHeight: 1.65 }}>零火线/单火接线、Wi-Fi 与继电器</div>
          </div>
          <div className="icard" style={{ borderLeftColor: ACC }}>
