...
function AnimCanvas({ modeRef }) {
  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      t += 0.025;
      const label = modeRef?.current || '等电位 · 接地网';
      ...
      ctx.fillText('避雷针、等电位连接与接地电阻', W/2, H - 12);
      ...
      <div className="grid2">
        ...
        <div className="info-stack reveal">
          <div className="icard" style={{ borderLeftColor: ACC }}>
            ...
            <div style={{ fontSize: 13.5, color: '#aabfc8', lineHeight: 1.65 }}>避雷针、等电位连接与接地电阻</div>
          </div>
          <div className="icard" style={{ borderLeftColor: ACC }}>
